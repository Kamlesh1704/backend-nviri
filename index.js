...
const corsOptions = {
  origin: ['https://nviri-assignment-4p1t.vercel.app', 'http://localhost:3000'], // Remove trailing slash in Vercel URL
...
// Explicitly handle OPTIONS preflight requests (though it's often done automatically by cors middleware)
